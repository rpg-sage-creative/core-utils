...
export function parseKeyValueArgs<ArgType extends string = string, ValueType extends string = string>(input: string, options?: RegExpKeyValueArgOptions): KeyValueArg<ArgType, ValueType>[];
