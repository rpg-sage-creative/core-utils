...
export function intializeNamedColors() {
    ...
    [
        ...
        { name: "Beige", hex: "#F5F5DC" }, { name: "Bisque", hex: "#FFE4C4" }, { name: "Black", hex: "#000000" },
        { name: "BlanchedAlmond", hex: "#FFEBCD" }, { name: "Blue", hex: "#0000FF" }, { name: "BlueViolet", hex: "#8A2BE2" },
        { name: "Brown", hex: "#A52A2A" }, { name: "BurlyWood", hex: "#DEB887" },
        { name: "CadetBlue", hex: "#5F9EA0" }, { name: "Chartreuse", hex: "#7FFF00" }, { name: "Chocolate", hex: "#D2691E" },
        { name: "Coral", hex: "#FF7F50" }, { name: "CornflowerBlue", hex: "#6495ED" }, { name: "Cornsilk", hex: "#FFF8DC" },
        { name: "Crimson", hex: "#DC143C" }, { name: "Cyan", hex: "#00FFFF" },
        ...
        { name: "GoldenRod", hex: "#DAA520" }, { name: "Gray", hex: "#808080" }, { name: "Grey", hex: "#808080" },
        { name: "Green", hex: "#008000" }, { name: "GreenYellow", hex: "#ADFF2F" },
        ...
        { name: "MediumBlue", hex: "#0000CD" }, { name: "MediumOrchid", hex: "#BA55D3" }, { name: "MediumPurple", hex: "#9370D8" },
        ...
        { name: "PaleVioletRed", hex: "#D87093" }, { name: "PapayaWhip", hex: "#FFEFD5" }, { name: "PeachPuff", hex: "#FFDAB9" },
        ...
        namedColors.set(colorCore.lower, color);
    });
